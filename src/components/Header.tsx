  ...
  return (
    <header className="mt-16 grid grid-cols-[auto,1fr] gap-x-6 gap-y-0.5 md:gap-x-10 md:gap-y-1.5">
      <Link
        ...
        href="/"
      >
        <div className="h-20 w-20 rounded-full bg-white bg-[url('/assets/profile.png')] bg-cover bg-center md:h-24 md:w-24" />
      </Link>
      <div className="mt-auto text-3xl sm:text-4xl md:text-5xl">
        <span className="font-bold">Durk</span>
        <span className="ml-2 hidden font-extralight text-gray-500 min-[365px]:inline-block">
          @ddddurk
        </span>
      </div>
      <span className="col-start-2 row-start-2 font-light text-gray-500 text-lg md:text-xl">
